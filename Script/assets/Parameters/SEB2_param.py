...
Trafo				=	dp.copy.deepcopy(Mags['Cyntec_EB2_Trafo'])																							#*	main transformer parameters
...
RCDclamp			= 	{																																	#*	RCD clamp parameters
                        ...
                        'Switch'     				:	dp.copy.deepcopy(Switches['SQJQ186ER_2'])														,	#?	clamp switch
					}
...
FRW					=	{																																	#*	freewheeler parameters
						'Config'					:	2																								,	#?	1->enable | 2->disable
						'Switch'					: 	dp.copy.deepcopy(Switches['SQJQ186ER_2'])														,	#?	freewheeling switch parameters
...
Lf					= 	dp.copy.deepcopy(Mags['Cyntec_EB2_Choke'])																							#*	LC filter output choke parameters
...
SC_Protection 		=	{																																	#*	internal short-circuit protection parameters
							'Switch'						:	dp.copy.deepcopy(Switches['SQJQ144AER'])													,	#?	short-circuit switch parameters
...
LV_currentSense 	= 	dp.copy.deepcopy(Sensors['INA240A1'])																								#*	LV current sensor
...
Rectifier_1			=	dp.copy.deepcopy(Switches['SQJQ186ER_1'])																							#*	LV rectifier switches parameters
Rectifier_2			=	dp.copy.deepcopy(Switches['SQJQ186ER_1'])																							#*	LV rectifier switches parameters
Rectifier_3			=	dp.copy.deepcopy(Switches['SQJQ186ER_1'])																							#*	LV rectifier switches parameters
Rectifier_4			=	dp.copy.deepcopy(Switches['SQJQ186ER_1'])																							#*	LV rectifier switches parameters
