...
Diode		= 	dp.copy.deepcopy(dp.Diodes_Dicts.AllDiodes)
Beads 		= 	dp.copy.deepcopy(dp.FerriteBeads_Dicts.AllFerriteBeads)
...
HVdmc				= 	dp.copy.deepcopy(Mags['Fastron_1R8'])																								#*	HVdmc filter choke parameters
...
Trafo				=	dp.copy.deepcopy(Mags['Gen6WE_A10_Trafo'])																							#*	main transformer parameters
...
RCDclamp			= 	{																																	#*	RCD clamp parameters
                        ...
                        'Switch'     				:	dp.copy.deepcopy(Switches['NVMJST3D3N08X'])														,	#?	clamp switch
					}
...
Lf					= 	dp.copy.deepcopy(Mags['Gen6WE_A10_Choke'])																							#*	LC filter output choke parameters
...
SC_Protection 		=	{																																	#*	internal short-circuit protection parameters
							'Switch'						:	dp.copy.deepcopy(Switches['NVMJST0D5N04XM'])											,	#?	short-circuit switch parameters
...
AC_voltageSense		=	dp.copy.deepcopy(Sensors['BuffDivider_4'])																							#*	AC cap voltage sensor
HV_voltageSense		=	dp.copy.deepcopy(Sensors['SI8932D'])																								#*	HV voltage sensor
LV_currentSense 	= 	dp.copy.deepcopy(Sensors['AD8411A'])																								#*	LV current sensor
...
PCMCbuck 			=	{																																	#*	peak buck mode controller
                            ...
                            'w_p0'					:	2*dp.np.pi*2.5e3																				,	#?	gain of origin pole for Type II
...
LeftLeg_1			=	dp.copy.deepcopy(Switches['AIMDQ75R040M2H'])																						#*	HV left leg switches parameters
LeftLeg_2			=	dp.copy.deepcopy(Switches['AIMDQ75R040M2H'])																						#*	HV left leg switches parameters
RightLeg_1			=	dp.copy.deepcopy(Switches['AIMDQ75R040M2H'])																						#*	HV right leg switches parameters
RightLeg_2			=	dp.copy.deepcopy(Switches['AIMDQ75R040M2H'])																						#*	HV right leg switches parameters

#! Rectifier Switches
#?----------------------------------------------------------------------------------------------------------------------------------------------------------------------

Rectifier_1			=	dp.copy.deepcopy(Switches['NVBYST0D6N08X'])																							#*	LV rectifier switches parameters
Rectifier_2			=	dp.copy.deepcopy(Switches['NVBYST0D6N08X'])																							#*	LV rectifier switches parameters
Rectifier_3			=	dp.copy.deepcopy(Switches['NVBYST0D6N08X'])																							#*	LV rectifier switches parameters
Rectifier_4			=	dp.copy.deepcopy(Switches['NVBYST0D6N08X'])																							#*	LV rectifier switches parameters
