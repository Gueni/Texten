...
SC_Protection 		=	{																																	#*	internal short-circuit protection parameters
							'Switch'						:	copy.deepcopy(Switches['NVMTS0D6N04C'])													,	#?	short-circuit switch parameters
...
Coc3				=	{																																	#*	LV filter third ceramic capacitors parameters
							...
							'Csingle'  				:	7.5e-6																							,   #?	single capacitor value
							'Rsingle'  				:	4e-3																							,   #?	ESR of single capacitor
							'Lsingle'  				:	90e-9																							,   #?	ESL of single capacitor
							'nPar' 	   				:	10																								,   #?	number of parallel connections
							'nSer' 	   				:	2																								,   #?	number of series connections
							'Vinit'    				:	Initials['Vout']	            																    #?	capacitor initial voltage
						}
...
Busbars_PCB			=	{																																	#*	PCB traces and/or busbars resistances
							'LV_Filter'		:	{																											#!	LV filter inline resistances
                                ...
                                'Plus_Terminal_1'		:	0																							,	#?	first filter plus terminal
								'Plus_Terminal_2'		:	10.0e-3																						,	#?	second filter plus terminal
								'Plus_Terminal_3'		:	2.5e-3																						,	#?	Third filter plus terminal
								'Minus_Terminal_1'		:	0																							,	#?	first filter negative terminal
								'Minus_Terminal_2'		:	10.0e-3																						,	#?	second filter negative terminal
								'Minus_Terminal_3'		:	2.5e-3																							#?	Third filter negative terminal
							},
...
Thermal 			=   {																																	#* 	thermal conditions
                            ...
                            'Derating'	:	{																												#*	boundary coniditions for derating functions
                                ...
                                'Pmax_2s_nom'		:	2600																							,	#?	max 2-sec power at 35°C water
                                'Pmax_2s_max'		:	1950																							,	#?	max 2-sec power at 75°C water
                                'Pmax_10s_nom'		:	2160																							,	#?	max 10-sec power at 35°C water
                                'Pmax_10s_max'		:	1822																							,	#?	max 10-sec power at 75°C water
                                'Pcont_nom'			:	1800																							,	#?	max continuous power at 35°C water
                                'Pcont_max'			:	1505																								#?	max continuous power at 75°C water
							},
